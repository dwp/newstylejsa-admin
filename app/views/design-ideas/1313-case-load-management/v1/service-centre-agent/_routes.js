module.exports = (app) => {
  ...
  const config = require('../../../../../config.js');
   ...
   router.post('/select-service-centre', function (req, res) {
    ...
    if (answer === 'leeds-100101') {
      ...
      res.render('design-ideas/1313-case-load-management/v1/service-centre-agent/index');
    }
  });
  ...
  router.post('/claim-status', function (req, res) {
    ...
    if (answer === 'claim-status-brought-forward') {
      ...
      res.render('design-ideas/1313-case-load-management/v1/service-centre-agent/claim-cleared');
    }
  });
  ...
  router.post("/nino-search", function (req, res) {
    ...
    if (answer === "invalid") {
      ...
      res.redirect(`/design-ideas/1313-case-load-management/v1/service-centre-agent/get-next-claim-2`);
    } else {
      // CC agent redirect
      if (app.locals.loggedInAgent === app.locals.agents[0]) {
        res.redirect(`/design-ideas/1313-case-load-management/v1/service-centre-agent/get-next-claim-1`);
