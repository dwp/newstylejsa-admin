module.exports = (app) => {
  ...
  const config = require('../../../../../config.js');
    ...
    router.post('/select-service-centre', function (req, res) {
      ...
      if (answer === 'leeds-100101') {
        ...
        res.render('design-ideas/1313-case-load-management/v1/service-centre-manager/index');
      }
    });
  ...
  router.post('/select-service-centre', function (req, res) {
    ...
    if (answer === 'leeds-100101') {
      ...
      res.render('design-ideas/1313-case-load-management/v1/service-centre-manager/centres/centre-update-southampton');
    }
  });
  ...
  router.post('/select-agent', function (req, res) {
    ...
    if (answer === 'andrew-server') {
      ...
      res.render('design-ideas/1313-case-load-management/v1/service-centre-manager/agents/agent-update-olivia');
    }
  });
    ...
    router.post("/nino-search", function (req, res) {
      ...
      if (answer === "invalid") {
        ...
        res.redirect(`/design-ideas/1313-case-load-management/v1/service-centre-manager/get-next-claim-3-notification`);
      } else {
        // CC agent redirect
        if (app.locals.loggedInAgent === app.locals.agents[0]) {
          res.redirect(`/design-ideas/1313-case-load-management/v1/service-centre-manager/get-next-claim-2`);
